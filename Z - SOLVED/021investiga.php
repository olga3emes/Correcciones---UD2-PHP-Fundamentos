...
$str = "Desarrollo de Aplicaciones Web";

/*ucwords:
Convierte en mayúsculas el primer caracter de cada palabra de una cadena*/

echo "<strong>ucwords:</strong>  " . ucwords($str) .  "</br>";

/*strrev:
Devuelve una cadena invertida*/
echo "<strong>strrev:</strong>  " . strrev($str) .  "</br>";


/*str_repeat:
Repite una cadena el número de veces que indiquemos*/
echo "<strong>str_repeat:</strong>  " . str_repeat($str, 2) .  "</br>";
...
echo "<strong>md5:</strong>  " . md5($str) .  "</br>";
